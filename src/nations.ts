...
export const NATION_NAMES: Record<NationId, Record<string, [string, string]>> = {
  china: {
    ...
    biplane: ['Caudron G.3', '高德隆双翼机'], triplane: ['Fokker Dr.I', '福克三翼机'], zeppelin: ['Recon Airship', '侦察飞艇'],
    ...
    fighter_ww2: ['Hawk III', '霍克III战斗机'], heavy_fighter: ['P-38 Lightning', '闪电重型战斗机'], dive_bomber: ['A-12 Shrike', '伯劳攻击机'],
    ...
    jet_fighter: ['J-35', '歼-35战机'], stealth_fighter: ['J-20', '歼-20隐身战机'], uav: ['GJ-11', '攻击-11无人机'],
  ...
  usa: {
    ...
    biplane: ['Curtiss JN-4', '柯蒂斯双翼机'], triplane: ['Curtiss 18T', '柯蒂斯三翼机'], zeppelin: ['DN-1 Airship', 'DN-1飞艇'],
    ...
    fighter_ww2: ['F4U Corsair', '海盗战斗机'], heavy_fighter: ['P-38 Lightning', 'P-38闪电'], dive_bomber: ['SBD Dauntless', '无畏俯冲轰炸机'],
    ...
    jet_fighter: ['F-35C', 'F-35C战机'], stealth_fighter: ['F-22 Raptor', 'F-22猛禽'], uav: ['MQ-9 Reaper', '死神无人机'],
  ...
  japan: {
    ...
    biplane: ['Yokosho Seaplane', '横厂水上机'], triplane: ['Mitsubishi 1MT', '一〇式三翼机'], zeppelin: ['Navy Airship', '海军飞行船'],
    ...
    fighter_ww2: ['A6M Zero', '零式战斗机'], heavy_fighter: ['J1N Gekko', '月光夜战机'], dive_bomber: ['D3A Val', '九九舰爆'],
    ...
    jet_fighter: ['F-35B', 'F-35B战机'], uav: ['Strike UAV', '攻击无人机'], stealth_fighter: ['F-3 Shinshin', 'F-3心神'],
  ...
  uk: {
    ...
    biplane: ['Sopwith Camel', '骆驼战斗机'], triplane: ['Sopwith Triplane', '索普威思三翼机'], zeppelin: ['Coastal Airship', '海岸飞艇'],
    ...
    fighter_ww2: ['Seafire', '海火战斗机'], heavy_fighter: ['DH Mosquito', '蚊式战斗机'], dive_bomber: ['Skua', '贼鸥俯冲轰炸机'],
    ...
    jet_fighter: ['F-35B', 'F-35B战机'], uav: ['Protector RG', '保护者无人机'], stealth_fighter: ['GCAP Tempest', '暴风隐身战机'],
  ...
  ussr: {
    ...
    biplane: ['Nieuport 17', '纽波尔战斗机'], triplane: ['Sikorsky S-16', '西科斯基战机'], zeppelin: ['Ilya Muromets', '伊利亚飞艇'],
    ...
    fighter_ww2: ['Yak-9', '雅克-9战斗机'], heavy_fighter: ['Pe-3', '佩-3重型战斗机'], dive_bomber: ['Pe-2', '佩-2俯冲轰炸机'],
    ...
    jet_fighter: ['Su-33', '苏-33战机'], stealth_fighter: ['Su-57', '苏-57隐身战机'], uav: ['Orion UAV', '猎户座无人机'],
