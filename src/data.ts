...
export const WEAPONS: Record<string, WeaponDef> = {
  ...
  heavy_gun: { id: 'heavy_gun', targets: ['sea'], range: 390, damage: 70, reload: 4.5, kind: 'shell', projSpeed: 520, splash: 26, vsBaseMult: 1 },
  ...
  big_gun: { id: 'big_gun', targets: ['sea'], range: 430, damage: 90, reload: 5.0, kind: 'shell', projSpeed: 580, splash: 30, vsBaseMult: 1 },
...
export const UNITS: Record<string, UnitDef> = {
  ...
  battleship: { id: 'battleship', name: 'Battleship', era: 'ww2', layer: 'sea', cost: 430, hp: 1650, speed: 28, weapons: ['big_gun', 'big_gun', 'aa_gun_ww2'], silhouette: 'dreadnought', bounty: 220, size: 1.6, desc: 'Floating fortress of big guns' },
...
export const ERAS: EraDef[] = [
  ...
  },
  {
    ...
    units: ['destroyer', 'battleship', 'carrier', 'submarine_ww2', 'fighter_ww2', 'torpedo_bomber'],
...
export const STAGES: StageDef[] = [
  ...
  // ---- WWII ----
  {
    id: 'ww2-1', era: 'ww2', index: 0, name: 'Channel Dash', enemyIncome: 10, enemyBaseHp: 1600, playerBaseHp: 2400,
    enemyPool: ['destroyer', 'destroyer', 'submarine_ww2'],
    enemyTurrets: [{ defId: 'flak88', slot: 2 }],
    waves: [
      { at: 8, units: ['destroyer'] },
      { at: 50, units: ['submarine_ww2'] },
      { at: 95, units: ['destroyer', 'fighter_ww2'] },
    ],
  },
  {
    id: 'ww2-2', era: 'ww2', index: 1, name: 'Wolfpack', enemyIncome: 10, enemyBaseHp: 2000, playerBaseHp: 2200,
    enemyPool: ['destroyer', 'submarine_ww2', 'fighter_ww2', 'torpedo_bomber'],
    ...
    waves: [
      ...
      { at: 150, units: ['battleship'] },
    ],
  },
  {
    id: 'ww2-3', era: 'ww2', index: 2, name: 'Pacific Storm', enemyIncome: 12, enemyBaseHp: 2400, playerBaseHp: 2400,
    enemyPool: ['destroyer', 'battleship', 'submarine_ww2', 'fighter_ww2', 'torpedo_bomber', 'carrier'],
  ...
  // ---- Modern ----
  {
    id: 'mod-1', era: 'modern', index: 0, name: 'Blockade', enemyIncome: 11, enemyBaseHp: 1800, playerBaseHp: 2400,
    enemyPool: ['lcs', 'lcs', 'uav'],
    enemyTurrets: [{ defId: 'ciws_mod', slot: 2 }],
    waves: [
      { at: 8, units: ['lcs'] },
      { at: 50, units: ['uav', 'lcs'] },
      { at: 95, units: ['missile_destroyer'] },
    ],
  },
  {
