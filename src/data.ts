...
export const WEAPONS: Record<string, WeaponDef> = {
  ...
  air_rockets: { id: 'air_rockets', targets: ['sea'], range: 260, damage: 60, reload: 4.5, kind: 'missile', projSpeed: 500, splash: 18, vsBaseMult: 0.5 },
...
export const UNITS: Record<string, UnitDef> = {
  ...
  triplane: { id: 'triplane', name: 'Triplane', era: 'ww1', layer: 'air', cost: 190, hp: 190, speed: 115, weapons: ['plane_mg', 'plane_mg'], silhouette: 'triplane', bounty: 95, size: 0.7, altitude: 140, desc: 'Ace dogfighter, twin machine guns' },
  ...
  boss_dreadnought: { id: 'boss_dreadnought', name: 'Super Dreadnought', era: 'ww1', layer: 'sea', cost: 0, hp: 3800, speed: 16, weapons: ['heavy_gun', 'heavy_gun', 'heavy_gun', 'aa_mg'], silhouette: 'super_dreadnought', bounty: 900, size: 2.1, desc: 'BOSS', boss: true },
  ...
  battleship: { id: 'battleship', name: 'Battleship', era: 'ww2', layer: 'sea', cost: 430, hp: 1650, speed: 28, weapons: ['big_gun', 'big_gun', 'aa_gun_ww2'], silhouette: 'battleship_ww2', bounty: 220, size: 1.6, desc: 'Huge guns: extreme range, slow reload' },
  ...
  submarine_ww2: { id: 'submarine_ww2', name: 'Submarine', era: 'ww2', layer: 'sub', cost: 290, hp: 400, speed: 34, weapons: ['torpedo_ww2'], silhouette: 'fleet_sub', bounty: 150, size: 1.0, desc: 'Long-range torpedo ambusher' },
  ...
  heavy_fighter: { id: 'heavy_fighter', name: 'Heavy Fighter', era: 'ww2', layer: 'air', cost: 300, hp: 320, speed: 120, weapons: ['fighter_mg', 'air_rockets'], silhouette: 'heavyfighter', bounty: 155, size: 0.85, altitude: 150, desc: 'Twin-engine strike fighter with rockets' },
  ...
  stealth_fighter: { id: 'stealth_fighter', name: 'Stealth Fighter', era: 'modern', layer: 'air', cost: 460, hp: 330, speed: 220, weapons: ['aam', 'drone_missile'], silhouette: 'stealth', bounty: 240, size: 0.85, altitude: 135, desc: '5th-gen multirole: air + strike' },
...
export const ERAS: EraDef[] = [
  {
    ...
    units: ['gunboat', 'cruiser_ww1', 'dreadnought', 'uboat', 'biplane', 'triplane', 'zeppelin'],
  ...
  },
  {
    ...
    units: ['pt_boat', 'destroyer', 'cruiser_ww2', 'battleship', 'carrier', 'submarine_ww2', 'fighter_ww2', 'heavy_fighter', 'dive_bomber', 'torpedo_bomber'],
  ...
  },
  {
    ...
    units: ['lcs', 'missile_destroyer', 'aegis_cruiser', 'nuke_sub', 'jet_fighter', 'stealth_fighter', 'uav'],
...
export const STAGES: StageDef[] = [
  ...
  },
  {
    ...
    playerUnits: ['gunboat', 'uboat', 'dreadnought', 'triplane', 'zeppelin'],
  ...
  },
  {
    ...
    enemyPool: ['cruiser_ww1', 'dreadnought', 'uboat', 'biplane', 'triplane', 'zeppelin'],
    enemyTurrets: [{ defId: 'howitzer_ww1', slot: 1 }, { defId: 'aa_nest_ww1', slot: 3 }],
    playerUnits: ['gunboat', 'cruiser_ww1', 'dreadnought', 'uboat', 'biplane', 'triplane', 'zeppelin'],
  ...
  },
  {
    ...
    playerUnits: ['destroyer', 'cruiser_ww2', 'submarine_ww2', 'fighter_ww2', 'heavy_fighter', 'dive_bomber'],
  ...
  },
  {
    ...
    enemyPool: ['destroyer', 'cruiser_ww2', 'battleship', 'submarine_ww2', 'fighter_ww2', 'heavy_fighter', 'torpedo_bomber', 'carrier'],
    enemyTurrets: [{ defId: 'coastal_ww2', slot: 1 }, { defId: 'flak88', slot: 2 }, { defId: 'flak88', slot: 3 }],
    playerUnits: ['destroyer', 'cruiser_ww2', 'battleship', 'carrier', 'submarine_ww2', 'fighter_ww2', 'heavy_fighter', 'dive_bomber', 'torpedo_bomber'],
  ...
  },
  {
    ...
    playerUnits: ['lcs', 'missile_destroyer', 'nuke_sub', 'stealth_fighter', 'uav'],
  ...
  },
  {
    ...
    enemyPool: ['lcs', 'missile_destroyer', 'aegis_cruiser', 'nuke_sub', 'jet_fighter', 'stealth_fighter', 'uav'],
    enemyTurrets: [{ defId: 'asm_mod', slot: 1 }, { defId: 'ciws_mod', slot: 2 }, { defId: 'ciws_mod', slot: 3 }],
    playerUnits: ['lcs', 'missile_destroyer', 'aegis_cruiser', 'nuke_sub', 'jet_fighter', 'stealth_fighter', 'uav'],
